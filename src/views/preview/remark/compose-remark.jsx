...
class ComposeRemark extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handlePost',
    ...
    handlePost () {
        ...
        api({
            uri: `/proxy/remark/project/${this.props.projectId}`,
...
const ConnectedComposeRemark = connect(
    mapStateToProps
)(ComposeRemark);

module.exports = ConnectedComposeRemark;
